...
nets = dict(
        xauz=math.Object(
        PARENT=networks.nets['xauz'],
        SHARE_PERIOD=15, # seconds
        CHAIN_LENGTH=24*60*60//10, # shares
        REAL_CHAIN_LENGTH=24*60*60//10, # shares
        TARGET_LOOKBEHIND=200, # shares
        SPREAD=3, # blocks
        IDENTIFIER='e037d5b8c6923411'.decode('hex'),#free +1
        PREFIX='7208c1a53ef629b1'.decode('hex'),#free +1
        P2P_PORT=15501,#le port P2P de P2pool : free +1
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=True,
        WORKER_PORT=15500,
        BOOTSTRAP_ADDRS=' '.split('37.187.64.233 142.4.202.97'),
        ...
        TARGET_LOOKBEHIND=200, # shares
        SPREAD=3, # blocks
        IDENTIFIER='e037d5b8c6923412'.decode('hex'),#free +1
        PREFIX='7208c1a53ef629b2'.decode('hex'),#free +1
        P2P_PORT=15507,#le port P2P de P2pool : free +1
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=True,
        WORKER_PORT=15506,
        BOOTSTRAP_ADDRS='37.187.64.233 142.4.202.97'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-ltc',
        VERSION_CHECK=lambda v: True,
        VERSION_WARNING=lambda v: 'Upgrade Node to >=0.8.5.1!' if v < 80501 else None,
    ),
