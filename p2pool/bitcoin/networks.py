...
nets = dict(
    xauz=math.Object(
        ...
        SYMBOL='XAUz',#ICI
        CONF_FILE_FUNC=lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Eurocoin') if platform.system() == 'Windows' else os.path.expanduser('~/Library/Application Support/Litecoin/') if platform.system() == 'Darwin' else os.path.expanduser('~/.XAUz'), 'XAUz.conf'),
    ...
    xptz=math.Object(
        ...
        BLOCK_PERIOD=300, # s (5 min)
        SYMBOL='XPTz',#ICI
        CONF_FILE_FUNC=lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Eurocoin') if platform.system() == 'Windows' else os.path.expanduser('~/Library/Application Support/Litecoin/') if platform.system() == 'Darwin' else os.path.expanduser('~/.XPTz'), 'XPTz.conf'),
